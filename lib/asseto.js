  ...
  Asseto = (function() {
    ...
    Asseto.prototype.c_amd_testacular = function(cb) {
      ...
      if (json) {
        ...
        conf.baseUrl = "/base/";
        conf.modules = void 0;
        return cb("window.onerror = function(msg, url, line) {\n  window.__testacular__.error(msg, url, line);\n  return false;\n};" + self.requirejs(JSON.stringify(conf), "['./app/app.test']", "window.__testacular__.start();"));
      } else {
        return cb();
      }
    };
